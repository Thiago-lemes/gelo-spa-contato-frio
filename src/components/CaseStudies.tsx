...
const caseStudies = [
  {
    ...
    description:
      "Instalação de sistema VRF em escritório de 500m² com 12 ambientes independentes, garantindo economia de energia e conforto térmico personalizado.",
    category: "Comercial",
    client: "TechCorp Solutions",
    imageUrl:
      "https://images.unsplash.com/photo-1604328698692-f76ea9498e76?q=80&w=1740&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Projeto e instalação de sistema multi-split para residência de alto padrão com 5 ambientes, integrado com sistema de automação residencial.",
    category: "Residencial",
    client: "Família Rodrigues",
    imageUrl:
      "https://images.unsplash.com/photo-1631083094028-01e31296899e?q=80&w=2070&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Solução integrada de refrigeração e climatização para restaurante premiado, incluindo cozinha industrial, adega climatizada e área de clientes.",
    category: "Comercial",
    client: "Sabor & Arte Restaurante",
    imageUrl:
      "https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?q=80&w=1932&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Sistema redundante de precisão para controle de temperatura em CPD de empresa de tecnologia, incluindo monitoramento 24/7 e alta disponibilidade.",
    category: "Industrial",
    client: "DataSecure",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Projeto personalizado para climatização eficiente em apartamento de 200m² com pé direito duplo, utilizando tecnologia inverter para maior economia.",
    category: "Residencial",
  ...
  },
  {
    ...
    description:
      "Sistema de ar-condicionado industrial para controle preciso de temperatura e umidade em fábrica têxtil, garantindo qualidade na produção.",
    category: "Industrial",
    client: "TextilTech Industrial",
    imageUrl:
      "https://images.unsplash.com/photo-1518792528501-352f829886dc?q=80&w=1170&auto=format&fit=crop",
    ...
    <section id="cases" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="text-center mb-12">
          <span className="inline-block text-blue-600 font-semibold mb-2 bg-blue-50 px-4 py-1 rounded-full">
            NOSSOS CASES
          </span>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Conheça alguns dos nossos projetos realizados com excelência e total
                ...
                <Card
                  ...
                  style={{
                    transform: `translateY(${
                      scrollPosition * 0.02 * ((caseItem.id % 3) + 1)
                    }px)`,
